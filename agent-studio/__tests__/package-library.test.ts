...
describe("package library metadata", () => {
  ...
  // referenced from a registry. @bezotcorp/extensions is allowed until it is
  // published to npm; @bezotcorp/typescript-client is temporarily allowed while
  // this stacked PR waits for the subscription client branch to merge/release.
  // TODO(#917): remove @bezotcorp/typescript-client exemption once
  // BezotCorp/typescript-client#178 merges and publishes to npm.
