...
This starts `ghcr.io/bezotcorp/agent-server:1.25.0-python` on
...
```bash
AGENT_SERVER_IMAGE=ghcr.io/bezotcorp/agent-server:$(gh api repos/BezotCorp/software-agent-sdk/commits/main --jq '.sha[0:7]')-python docker compose up
```
